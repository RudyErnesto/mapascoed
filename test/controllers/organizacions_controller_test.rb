...
class OrganizacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organizacion" do
    assert_difference('Organizacion.count') do
      post organizacions_url, params: { organizacion: { correo: @organizacion.correo, estado: @organizacion.estado, nombre: @organizacion.nombre, numerocontacto: @organizacion.numerocontacto, telefono: @organizacion.telefono } }
    end
  ...
  test "should update organizacion" do
    patch organizacion_url(@organizacion), params: { organizacion: { correo: @organizacion.correo, estado: @organizacion.estado, nombre: @organizacion.nombre, numerocontacto: @organizacion.numerocontacto, telefono: @organizacion.telefono } }
