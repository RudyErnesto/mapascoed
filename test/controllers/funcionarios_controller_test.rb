...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { apellido: @funcionario.apellido, celular: @funcionario.celular, correo: @funcionario.correo, nombre: @funcionario.nombre, telefono: @funcionario.telefono } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { apellido: @funcionario.apellido, celular: @funcionario.celular, correo: @funcionario.correo, nombre: @funcionario.nombre, telefono: @funcionario.telefono } }
