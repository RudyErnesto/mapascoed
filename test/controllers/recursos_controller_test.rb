...
class RecursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recurso" do
    assert_difference('Recurso.count') do
      post recursos_url, params: { recurso: { clase: @recurso.clase, estado: @recurso.estado, matricula: @recurso.matricula, nombre: @recurso.nombre, tipo: @recurso.tipo } }
    end
  ...
  test "should update recurso" do
    patch recurso_url(@recurso), params: { recurso: { clase: @recurso.clase, estado: @recurso.estado, matricula: @recurso.matricula, nombre: @recurso.nombre, tipo: @recurso.tipo } }
